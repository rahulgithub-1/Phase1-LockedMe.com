...
//	PROMPTS FOR INTERACTIVITY
	private static final String WELCOME_PROMPT = "\n________________  LockedMe.com  ________________"
			+ "\n________________ Rahul Kashyap  ________________ \n";

	private static final String MAIN_MENU_PROMPT = "\nMAIN MENU - Select any of the following: \n"
			+ "1 -> List files in directory (ASC Order)\n"
			+ "2 -> Business Level Operation i.e. Add, Delete or Search\n" + "3 -> Exit Program";

	private static final String SECONDARY_MENU_PROMPT = "   \nSelect any of the following: \n" + "   a -> Add a file\n"
			+ "   b -> Delete a file\n" + "   c -> Search a file\n" + "   d -> GoBack";

//	Algorithm to show Primary Menu for the features interaction
...
//Business Level Method i.e. for add, delete , search and going back to main menu
...
//	Algorithm to showFiles in Directory in Ascending Order using inbuilt sort function
	void showFiles() {
...
//	Algorithm to AddFile in Directory
...
// Algorithm to Delete File via filename Parameter
...
//  Algorithm to Search File via filename Parameter (case sensitive)
